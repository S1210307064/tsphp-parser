...
public class NamespaceBracketInstructionTest extends AParserTest
{

    public NamespaceBracketInstructionTest(String testString) {
        super(testString);
    }
    ...
    public static Collection<Object[]> testStrings() {
        ...
        collection.addAll(InstructionHelper.getInstructions("namespace{", "}"));
        return collection;
    }
}
