...
public class ConstructDestructDefinitionErrorTest extends AParserParserExceptionTest
{

    public ConstructDestructDefinitionErrorTest(String testString, int character, int position) {
    ...
    public static Collection<Object[]> testStrings() {
        return Arrays.asList(new Object[][]{
                {"function $notConstructOrDestruct", TSPHPParser.VariableId, 9},
        });
    }
}
