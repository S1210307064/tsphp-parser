...
public class ArrayErrorTest extends AParserParserExceptionTest
{

    public ArrayErrorTest(String testString, int character, int position) {
    ...
    public static Collection<Object[]> testStrings() {
        return Arrays.asList(new Object[][]{
                {"$notArrayOrLeftSquareBracket", TSPHPParser.VariableId, 0}
        });
    }
}
